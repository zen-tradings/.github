...
Benchmarks, evaluation harnesses, internal QA tooling, shared team skills.
...
- [team_skills](https://github.com/zen-tradings/team_skills) — Shared SKILL.md files for team tooling
...
- Tag every repo with a topic: `internal-eval`, `quant-infra`, or `quant-strategy`
- Browse by category: [Internal Eval](https://github.com/orgs/zen-tradings/repositories?q=topic:internal-eval) · [Quant Infra](https://github.com/orgs/zen-tradings/repositories?q=topic:quant-infra) · [Quant Strategy](https://github.com/orgs/zen-tradings/repositories?q=topic:quant-strategy)
